...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN] = LAYOUT(
        ...
        KC_LSFT,     KC_LCTL,     KC_LALT,     KC_LCMD,     KC_BSPC, OSL(_SYM),    OSL(_NUM),     SFT_T(KC_SPC), KC_TAB,      KC_ESC,      MO(_FN),     TO(_HJKL)),
    ...
    [_SYM] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,   KC_NO, TO(_NUM),  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
    ...
    [_FN] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,   TO(_SYM), TO(_NUM), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),


    [_HJKL] = LAYOUT(
        KC_Q,        KC_W,        KC_F,        KC_P,        KC_G,                                 KC_H,          KC_J,        KC_K,        KC_L,        CTRL_SPACE,
        SFT_T(KC_A), CTL_T(KC_S), ALT_T(KC_R), CMD_T(KC_T), KC_D,                                 KC_M,          CMD_T(KC_N), ALT_T(KC_E), CTL_T(KC_I), SFT_T(KC_O),
        KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,    OSM(MOD_MEH), OSM(MOD_HYPR), KC_Y,          KC_U,        KC_COMM,     KC_DOT,      KC_ENT,
        KC_LSFT,     KC_LCTL,     KC_LALT,     KC_LCMD,     KC_BSPC, OSL(_SYM),    OSL(_NUM),     SFT_T(KC_SPC), KC_TAB,      KC_ESC,      MO(_FN),     TO(_MAIN)),
};
